...
<%@ include file="include/header.jsp" %>
    ...
    <section>
        <div class="container" style="padding-top: 30px">
            ...
            <br>
		    <form:form action="${pageContext.request.contextPath}/admin/teachers/register" modelAttribute="teacher" method="POST">
                ...
                <div class="form-group">
                    ...
                    <form:input path="login.email" id="email" class="form-control"/>
                </div>
                <div class="form-group">
                    <label for="password">Password</label>
                    <form:password path="login.password" id="password" class="form-control"/>
                </div>
                <div class="form-group">
